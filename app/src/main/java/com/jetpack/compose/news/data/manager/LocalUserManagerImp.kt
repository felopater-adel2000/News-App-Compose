package com.jetpack.compose.news.data.manager
...
import com.jetpack.compose.news.util.Constants
...
class LocalUserManagerImp (
    ...
    override fun readAppEntry(): Flow<Boolean> {
        return context.dataStore.data.map { it[PreferenceKeys.APP_ENTRY] ?: false }
    }
}
